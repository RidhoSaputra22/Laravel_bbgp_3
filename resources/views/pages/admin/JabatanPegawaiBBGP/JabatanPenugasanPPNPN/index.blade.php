@extends('layouts.app', ['title' => 'kabupaten'])
                                        ...
                                        <tbody>
                                            @foreach ($datas as $i => $data)
                                                <tr>
                                                    ...
                                                    <td>{{ $data->name ?? '' }}</td>
                                                    <td>
                                                        <a href="{{ route('kabupaten.edit', $data->id) }}" class="btn btn-warning my-2">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <button onclick="deleteData({{ $data->id }}, 'kabupaten')" class="btn btn-danger">
    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                var language = {
                    "sSearch": "Pencarian Data Kabupaten : ",
                };

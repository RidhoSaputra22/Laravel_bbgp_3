    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Artikel {{ session('message') }}</h1>
            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input required type="text" name="judul" value="{{ $data->judul }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-6 col-md-4 mt-3">
                                            ...
                                            <img class="img img-fluid" width="250"
                                                src="{{ asset('upload/artikel/' . $data->thumbnail) }}" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        ...
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tanggal
                                            Publish</label>
                                        <div class="col-sm-6 col-md-4">
                                            <input class="form-control" value="{{ $data->tgl_publish }}" type="date"
                                                name="tgl_publish" />
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <button class="btn btn-primary">Ubah Aartikel </button>

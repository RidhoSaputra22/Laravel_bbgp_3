                              ...
                              <div class="col-md">
                                 <div class="form-group">
                                    ...
                                    <input value="{{ $datas->username }}" name="username" required
                                       placeholder="Masukkan Usernam untuk login" type="text" class="form-control">
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input name="password" value="" placeholder="Masukkan Password" type="password"
                                       class="form-control">
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label>Role</label>
                                    <select name="role" required placeholder="Masukkan Akun" class="form-control">
                                       ...
                                       <option {{ $datas->role == 'stakeholder' ? 'selected' : '' }} value="stakeholder">
                                          stakeholder</option>
                                       <option {{ $datas->role == 'pegawai' ? 'selected' : '' }} value="pegawai">Pegawai
                                          BBGTK</option>
                                       <option {{ $datas->role == 'database' ? 'selected' : '' }} value="database">
                                          Database</option>
                                       <option {{ $datas->role == 'superadmin' ? 'selected' : '' }} value="superadmin">
                                          superadmin</option>
                                    </select>
                                 </div>
                              </div>

@extends('layouts.app', ['title' => 'Data Eksternal'])
@section('content')
    @push('styles')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="alamat_rumah" class="form-control" placeholder="isi dengan lengkap ">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select  name="jabTugas" class="form-control select2"
                                                    id="jabTugas">
